...
public record CreateWalletTransactionResponseDto(
  Long id, // 거래 ID
  ...
  public static CreateWalletTransactionResponseDto from(WalletTransaction wt) {
    return new CreateWalletTransactionResponseDto(
      wt.getId(),
      wt.getWallet().getId(),
